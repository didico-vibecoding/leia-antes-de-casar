    ...
    <div className="page-shell flex min-h-screen flex-col">
      ...
      <footer className="border-t bg-soft text-soft-foreground">
        <div className="content-wrap grid gap-6 px-4 py-8 text-sm sm:px-6 md:grid-cols-[1fr_auto] lg:px-8">
          ...
          <p>Este site é fruto de um Projeto de Extensão da disciplina de Direito Civil - Família, da Univali, Campus Kobrasol. O projeto tem somente fins educativos e informacionais. Não substitui consultoria jurídica. Consulte sempre um advogado.</p>
