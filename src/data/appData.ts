...
export const modules: ModuleData[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { titulo: "Pacto antenupcial: como formalizar", paragrafos: ["O pacto antenupcial é o contrato formal entre os futuros cônjuges para definir o regime de bens e outras regras patrimoniais. Ele deve ser feito por escritura pública, em tabelionato de notas, antes do casamento e durante o processo de habilitação.", "Para ter eficácia contra terceiros, o pacto precisa ser averbado no Registro Civil e registrado no Cartório de Registro de Imóveis do domicílio do casal e dos locais onde houver bens imóveis."], box: { tipo: "Atenção", texto: "O pacto só vale após o casamento. Sem o registro adequado, o regime escolhido pode não surtir efeitos perante terceiros." } },
  ...
  },
  {
    ...
    sections: [
      ...
      { titulo: "Partilha, alimentos e guarda", paragrafos: ["Em regra, os alimentos entre ex-cônjuges possuem caráter temporário. O objetivo é proporcionar apoio financeiro durante o período necessário para que a pessoa possa reorganizar sua vida e alcançar autonomia econômica, sempre considerando as circunstâncias de cada caso concreto.", "Para garantir maior estabilidade à rotina da criança, normalmente é estabelecida uma residência de referência, utilizada para organizar questões como escola, atendimento médico e demais atividades do cotidiano.", "Isso não reduz os direitos ou deveres de nenhum dos pais, que continuam compartilhando as decisões importantes sobre a vida do filho."], box: { tipo: "Exemplo prático", texto: "O casal pode divorciar e deixar a partilha para depois, quando isso for juridicamente adequado." } },
    ],
    quiz: [
      { pergunta: "O divórcio extrajudicial (em cartório) pode ocorrer com filhos menores ou incapazes desde que...", correta: "Haja acordo e as questões de guarda, convivência e alimentos já estejam decididas judicialmente", alternativas: quizAlternativas("Haja acordo e as questões de guarda, convivência e alimentos já estejam decididas judicialmente", ["Não haja acordo entre os cônjuges", "Os filhos sejam maiores de idade", "Não haja bens a partilhar"]), explicacao: "O divórcio cartorial é possível mesmo com filhos menores/incapazes, desde que guarda, convivência e alimentos já tenham sido resolvidos por decisão judicial." },
