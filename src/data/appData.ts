...
export const modules: ModuleData[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { titulo: "Partilha, alimentos e guarda", paragrafos: ["Em regra, os alimentos entre ex-cônjuges possuem caráter temporário. O objetivo é proporcionar apoio financeiro durante o período necessário para que a pessoa possa reorganizar sua vida e alcançar autonomia econômica, sempre considerando as circunstâncias de cada caso concreto.", "Para garantir maior estabilidade à rotina da criança, normalmente é estabelecida uma residência de referência, utilizada para organizar questões como escola, atendimento médico e demais atividades do cotidiano."], box: { tipo: "Exemplo prático", texto: "O casal pode divorciar e deixar a partilha para depois, quando isso for juridicamente adequado." } },
    ],
    quiz: [
