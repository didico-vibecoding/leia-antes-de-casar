import { Baby, Balance, Banknote, BookOpen, CheckSquare, CircleDollarSign, FileHeart, Gavel, HeartHandshake, Home, Landmark, Scale, ScrollText, Shield, Sparkles } from "lucide-react";
...
export const modules: ModuleData[] = [
  ...
  },
  {
    ...
    sections: [
      { titulo: "Divórcio hoje é direito", paragrafos: ["O divórcio pode ser judicial ou extrajudicial. Quando há acordo e não existem filhos menores ou incapazes, o cartório pode ser uma via mais simples.", "Com filhos menores, conflito ou temas sensíveis, o caminho judicial protege interesses envolvidos."], box: { tipo: "Atenção", texto: "Mesmo no cartório, a presença de advogado é necessária para orientar e formalizar o ato." } },
